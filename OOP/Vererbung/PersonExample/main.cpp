...
int main(){
    ...
    cout<<"Klasse Mitarbeiter ist eine unterklasse von Person!" << endl;

    Kontakt k1("Email", "test@gmail.com");
    Kontakt k2("Mobile Phone", "+49 123456789");    
    
    Mitarbeiter m ("Büro 123", "Maria Musterfrau", 1.7, 22, true, 'w', 1.70, k1, k2);
    cout <<"Mitarbeiter: " <<  m.getName() <<", " << m.getBueronummer() << ", " << "Age: " << m.getAge() <<endl;
